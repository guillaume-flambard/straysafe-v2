...
CREATE OR REPLACE TRIGGER create_default_notification_settings_trigger
...
CREATE OR REPLACE TRIGGER update_user_push_tokens_updated_at
    BEFORE UPDATE ON user_push_tokens
    FOR EACH ROW
    EXECUTE FUNCTION update_updated_at_column();

CREATE OR REPLACE TRIGGER update_user_notification_settings_updated_at
